...
urlpatterns = [
   ...
   # virtuallab/urls.py
    ...
    path('experiment/<int:experiment_id>/', views.experiment_detail),
    path('experiments/<int:experiment_id>/pdf/', views.report_pdf, name='report_pdf'),
    path('experiments/<int:experiment_id>/submit_report/', views.submit_report, name='submit_report'),
    path('experiments/<int:experiment_id>/submitted/', views.report_submitted, name='report_submitted'),
    path('experiments/<int:experiment_id>/auto_save_draft/', views.auto_save_draft, name='auto_save_draft'),
    path('experiments/<int:experiment_id>/auto_save_report/', views.auto_save_report, name='auto_save_report'),
